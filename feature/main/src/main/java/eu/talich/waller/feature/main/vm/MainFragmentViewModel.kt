...
import eu.talich.waller.common.ui.system.TabbedFragment
...
class MainFragmentViewModel(
    ...
    fun getTabTitle(position: Int): String {
        return app.getString((pagerFragments[position] as eu.talich.waller.common.ui.system.TabbedFragment).title)
    }
